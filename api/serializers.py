...
class WorkScheduleSerializer(serializers.ModelSerializer):
    ...
    def validate(self, data):
        ...
        existing_schedules = WorkSchedule.objects.filter(user=user, date=date)
...
class BookingSerializer(serializers.ModelSerializer):
    ...
    def validate(self, data):
        ...
        if not (work_schedule.start_time <= booking_start_time <= work_schedule.end_time) or \
                not (work_schedule.start_time <= booking_end_time <= work_schedule.end_time):
